...
class WcCallout extends LitElement {
  ...
  static styles=css\`
    ...
    .tip{background:rgba(1,105,111,.1);border-color:rgba(1,105,111,.3);color:#3d7a83}
...
class WcBadge extends LitElement {
  ...
  static styles=css\`
    ...
    .default{background:rgba(1,105,111,.15);color:#3d7a83;border-color:rgba(1,105,111,.3)}
...
class WcUpdate extends LitElement {
  ...
  static styles=css\`
    ...
    :host([theme="light"]){--surface:#f8f8f8;--border:#e2e2e2;--text:#0f0f0f;--text2:#555;--text3:#737373}
