...
class WcFrame extends LitElement {
  ...
  static styles=css\`
    ...
    figcaption{padding:10px 16px;font-family:'Inter',sans-serif;font-size:13px;color:#666;border-top:1px solid #2a2a2a;text-align:center}
...
class WcPanel extends LitElement {
  ...
  static styles=css\`
    ...
    .title{font-family:'Inter',sans-serif;font-size:14px;font-weight:600;color:#e2e8f0}
    .body{padding:16px 18px;font-family:'Inter',sans-serif;font-size:14px;color:#a0a0a0;line-height:1.7}
    ::slotted(*){max-width:100%}
...
class WcAside extends LitElement {
  ...
  static styles=css\`
    ...
    .wrap{background:#111;border:1px solid #2a2a2a;border-radius:10px;padding:16px 18px;font-family:'Inter',sans-serif;font-size:13px;color:#a0a0a0;line-height:1.7}
    .title{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#666;margin-bottom:8px}
    ::slotted(*){max-width:100%}
